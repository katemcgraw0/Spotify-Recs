  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100">
      ...
      <main className="text-center">
        ...
        {session && (
          <div className="red">
            <p className="mb-4">Signed in as {session.user.name}. You can now access your data.</p>
            <div className="flex flex-col">
              <Link legacyBehavior href="/artists">
                <a className="text-white bg-purple-500 hover:bg-purple-600 font-bold text-lg py-3 px-6 rounded mb-4">
