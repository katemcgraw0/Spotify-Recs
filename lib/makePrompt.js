export function makePrompt(favArtists, favGenres) {
    ...
    const conclusionAndFormat = `Guess my zodiac sign based on this. Please format your answer in the following format, with no additional text. Please use my music taste as reasons this is my zodiac sign. First listing your guess formatted as follows, then a list of reasons why each separated by a new line. Please address me in the reasons as 'you' and keep them short.:
      'Sign: [Zodiac Sign].
      1.
      2.
      3.
